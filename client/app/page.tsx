    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden flex flex-col items-center justify-center border-b border-neutral-800 bg-black">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter text-white mb-6 drop-shadow-sm">
      ...
      <section className="py-20 max-w-[1400px] mx-auto px-6">
        ...
        {/* Horizontal scrolling category filter — prevents wrapping on mobile */}
        <div className="flex gap-2 overflow-x-auto pb-2 mb-12 sm:mb-16 sm:flex-wrap sm:justify-center scrollbar-none -mx-4 px-4 sm:mx-0 sm:px-0">
          {DEPARTMENTS.map(cat => (
            <button
              key={cat}
                ...
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 border-b border-emerald-500/20 pb-4">
                  <div>
                    <h2 className="text-xl sm:text-3xl font-black text-white flex items-center gap-2 sm:gap-3">
                      <Zap className="text-emerald-500 w-6 h-6 sm:w-8 sm:h-8 flex-shrink-0" /> Open Source <span className="text-emerald-500">Tier</span>
                    </h2>
                    <p className="text-neutral-500 mt-1 text-sm sm:text-base">High-quality educational streams strictly available at no cost.</p>
                  </div>
            ...
            {paidCourses.length > 0 && (
              <div className="space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 border-b border-amber-500/20 pb-4">
                  <div>
                    <h2 className="text-xl sm:text-3xl font-black text-white flex items-center gap-2 sm:gap-3">
                      <Award className="text-amber-500 w-6 h-6 sm:w-8 sm:h-8 flex-shrink-0" /> Enterprise <span className="text-amber-500">Curriculum</span>
                    </h2>
                    <p className="text-neutral-500 mt-1 text-sm sm:text-base">Intensive professional-grade certifications and bootcamps.</p>
                  </div>
